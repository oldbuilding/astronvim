return {
  ...
  opts = {
    ...
    modes = {
      ...
      symbols = {
        ...
        win = {
          wo = { winfixheight = false, winfixwidth = false },
        },
        filter = {
  ...
  keys = {
    ...
    {
      "<Leader>xdc",
      "<Cmd>Trouble cascade win.wo.winfixwidth=true<CR>",
    ...
    {
      "<Leader>xdp",
      "<Cmd>Trouble cascade prev win.wo.winfixwidth=true<CR>",
      desc = "Prev Diagnostic",
    },
    {
      "<Leader>xdn",
      "<Cmd>Trouble cascade next win.wo.winfixwidth=true<CR>",
      desc = "Next Diagnostic",
    },
    -- SYMBOLS
    {
      "<Leader>xss",
      "<Cmd>Trouble lsp_document_symbols focus=true win.position=bottom<CR>",
