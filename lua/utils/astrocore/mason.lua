...
---
---This module can be loaded with `local mason_utils = require("utils.astrocore.mason")`
---
---copyright 2023
---license GNU General Public License v3.0
---@class utils.astrocore.mason
local M = {}

local astro = require("utils.astrocore")
...
function M.update(pkg_names, auto_install)
  ...
  registry.update(vim.schedule_wrap(function(success, updated_registries)
    if success then
      ...
      if vim.tbl_count(pkg_names) == 0 then mason_notify(("Successfully updated %d %s."):format(count, count == 1 and "registry" or "registries")) end
